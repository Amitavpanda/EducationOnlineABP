...
public class OnlineEducationDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public OnlineEducationDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
